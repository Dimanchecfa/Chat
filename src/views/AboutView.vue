        ...
        <section
          ...
          <!-- <div class="active-users flex flex-row p-2 overflow-auto w-0 min-w-full">
                    <div class="text-sm text-center mr-4">
                        <button class="flex flex-shrink-0 focus:outline-none block bg-gray-200 text-gray-500 rounded-full w-20 h-20"
                                type="button">
            ...
            <div class="flex flex-row justify-start">
              ...
              <div class="messages text-sm text-gray-700 grid grid-flow-row gap-2">
                <div class="flex items-center group">
                  <p class="px-6 py-3 rounded-t-full rounded-r-full bg-gray-100 max-w-xs lg:max-w-md">Hey! How are you?
                  </p>
                  <button type="button"
                ...
                <div class="flex items-center group">
                  <p class="px-6 py-3 rounded-r-full bg-gray-100 max-w-xs lg:max-w-md">Shall we go for Hiking this
                    weekend?</p>
                  <button type="button"
                    class="hidden group-hover:block flex flex-shrink-0 focus:outline-none mx-2 block rounded-full text-gray-500 hover:text-gray-800 hover:bg-gray-200 bg-gray-100 w-8 h-8 p-2">
                    <svg viewBox="0 0 20 20" class="w-full h-full fill-current">
